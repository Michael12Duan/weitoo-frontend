define("angular/angular-all", [], function(require, exports, module) {
    require("/wt/sea-modules/angular/1.2.25/angular.js");
    require("/wt/sea-modules/angular/plugins/route/angular-route.js");
    require("/wt/sea-modules/angular/plugins/translate/angular-translate.js");
...
define("angular/1.2.25/angular", [], function(require, exports, module) {
    /*
     AngularJS v1.2.25
    ...
    (function(W, X, t) {
        ...
        function D(b) {
            return function() {
                var a = arguments[0],
                    c, a = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.2.25/" + (b ? b + "/" : "") + a;
        ...
        function r(b, a, c) {
            ...
            if (b)
                ...
                //b= "{"nonce":"z8k0ymfsgs34kpaevhl9hrpl9oc4mv3k","hashKey":"9e817198337c5a7df65e228e35f2027227f7ed928f852218e0aa5828b091f49a","password":"15e0087caca7","a
                    a.call(c, b[d], d);
        ...
        function hb() {
            for (var b = ma.length, a; b;) {
                ...
                if (90 == a)
                    ...
                    return ma[b] = String.fromCharCode(a + 1),
                        ma.join("")
            }
            ma.unshift("0");
            return ma.join("")
        ...
        function Ha(b, a, c, d) {
            ...
            if (a) {
                ...
                I(b) ? a = Ha(b, [], c, d) : ta(b) ? a = new Date(b.getTime()) : jb(b) ? (a = RegExp(b.source, b.toString().match(/[^\/]*$/)[0]),
        ...
        function Aa(b, a) {
            ...
            if (c == typeof a && "object" == c)
                if (I(b)) {
                    ...
                    if (ta(b))
                        return ta(a) ? isNaN(b.getTime()) && isNaN(a.getTime()) || b.getTime() ===
                            a.getTime() : !1;
                    if (jb(b) && jb(a))
        ...
        function Ua(b) {
            "function" === typeof b ? b = !0 : b && 0 !== b.length ? (b = M("" + b),
        ...
        function sc(b) {
            ...
            "function" === typeof b ? (a = b.$inject) || (a = [],
                b.length && (c = b.toString().replace(pe, ""),
                    c = c.match(qe),
                ...
                b.$inject = a) : I(b) ? (c = b.length - 1,
                Wa(b[c], "fn"),
                a = b.slice(0, c)) : Wa(b, "fn", !0);
            return a
        }
        ...
        function te(b, a, c, d) {
                    ...
                    if (N != a)
                        return N = a,
                            d.history ? c ? l.replaceState(null, "", a) : (l.pushState(null, "", a),
                                R.attr("href", R.attr("href"))) : (w = a,
                                c ? h.replace(a) : h.href = a),
                            k
                } else
            ...
            k.cookies = function(a, b) {
                var d, e, f, k;
                if (a)
                    b === t ? m.cookie = escape(a) + "=;path=" + C + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : A(b) && (d = (m.cookie = escape(a) + "=" + escape(b) + ";path=" + C).length + 1,
                    ...
                    if (m.cookie !==
                        ...
                        for (da = m.cookie,
                            ...
                            e = d[f],
                            k = e.indexOf("="),
                            0 < k && (a = unescape(e.substring(0, k)),
                                O[a] === t && (O[a] = unescape(e.substring(k + 1))));
                    return O
                }
            };
                ...
                function K(a, b, c, d, e, f) {
                    function g(a, c, d, e) {
                        ...
                        for (n = m.length; q < n; p++)
                            ...
                            f = m[q++],
                            c ? (c.scope ? (l = a.$new(),
                                    v.data(h, "$scope", l)) : l = a,
                                s = c.transcludeOnThisElement ? O(a, c.transclude, e) : !c.templateOnThisElement && e ? e : !e && b ? O(a, b) : null,
                                c(f, l, h, d, s)) : f && f(a, h.childNodes, t, e)
                    }
                    for (var m = [], h, l, q, n, p = 0; p < a.length; p++)
                        h = new Ob,
                        l = da(a[p], [], h, 0 === p ? d : t, e), (f = l.length ? H(l, a[p], h, b, c, null, [], [], f) : null) && f.scope && ca(h.$$element, "ng-scope"),
                        h = f && f.terminal || !(q = a[p].childNodes) || !q.length ?
                        null : K(q, f ? (f.transcludeOnThisElement || !f.templateOnThisElement) && f.transclude : b),
                        m.push(f, h),
                        n = n || f || h,
                        f = null;
                    return n ? g : null
                ...
                function H(a, c, d, e, f, g, m, n, p) {
                    ...
                    function N(a, e, f, g, p) {
                        ...
                        for (w = m.length; g < w; g++)
                            try {
                                O = m[g],
                                    O(O.isolateScope ? C : e, L, u, O.require && B(O.directiveName, O.require, L, da), rb)
                            } catch (G) {
                                l(G, ia(L))
                            }
                        g = e;
                    ...
                    for (var u = -Number.MAX_VALUE,
                        ...
                        if (V = G.scope)
                            O = O || G,
                            G.templateUrl || (db("new/isolated scope", K, G, Z),
                                T(V) && (K = G));
                        D = G.name;
                        !G.templateUrl && G.controller && (V = G.controller,
                            R = R || {},
                            db("'" + D + "' controller", R[D], G, Z),
                            R[D] = G);
                        if (V = G.transclude)
                            y = !0,
                            G.$$tlb ||
                            (db("transclusion", fa, G, Z),
                                fa = G),
                            "element" == V ? (M = !0,
                                u = G.priority,
                                V = Z,
                                Z = d.$$element = v(X.createComment(" " + D + ": " + d[D] + " ")),
                                c = Z[0],
                                Na(f, Ba.call(V, 0), c),
                                S = w(V, e, u, g && g.name, {
                        ...
                        if (G.template)
                            if (J = !0,
                                db("template", H, G, Z),
                                H = G,
                                V = P(G.template) ? G.template(Z, d) : G.template,
                                V = W(V),
                                G.replace) {
                                g = G;
                                V = Ib.test(V) ? v(aa(V)) : [];
                        ...
                        if (G.templateUrl)
                            ...
                            try {
                                Q = G.compile(Z, d, S),
                                    P(Q) ? E(null, Q, U, Y) : Q && E(Q.pre, Q.post, U, Y)
                            } catch (ve) {
                                l(ve, ia(Z))
                            }
                        G.terminal && (N.terminal = !0,
                            u = Math.max(u, G.priority))
                    }
                    N.scope = O && !0 === O.scope;
                ...
                function ue(a, b, c, d, e, f, g, h) {
                    ...
                    return function(a, b, c, d, e) {
                        ...
                        m ? (m.push(b),
                            m.push(c),
                            m.push(d),
                            m.push(a)) : (l.transcludeOnThisElement && (a = O(b, l.transclude, e)),
                            l(q, b, c, d, a))
                    }
                }
            ...
            this.$get = ["$injector", "$window", function(c, d) {
                return function(e, f) {
                    ...
                    A(e) && (g = e.match(a),
                        k = g[1],
                        m = g[3],
                        e = b.hasOwnProperty(k) ? b[k] : hc(f.$scope, k, !0) || hc(d, k, !0),
                        Wa(e, k, !0));
                    g = c.instantiate(e, f);
                    if (m) {
                        if (!f || "object" !== typeof f.$scope)
                            throw D("$controller")("noscp",
                                k || e.name, m);
                        f.$scope[m] = g
                    }
                    return g
        ...
        function wc(b) {
            //b = Object {UT: undefined, Content-Type: "application/json; charset=UTF-8", Accept: "application/json;charset=UTF-8"}
            var a = T(b) ? b : t;
            return function(c) {
                a || (a = vc(b));
        ...
        function Ud() {
            var b = /^\s*(\[|\{[^\{])/,
                ...
                e = this.defaults = {
                    ...
                    //cross-site request forgery 跨站点请求伪造 防止用户在不知觉的情况下，被修改了密码。
            ...
            this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function(a, b, c, d, n, p) {
                ...
                function q(a) {
                    //the function q(a) was called by the function in main.js in module'app/support/services/resturl' variable is 'o'
                    function b(a) {
                        var d = J({}, a, {
                    ...
                    var f = [function(a) {
                            //a = Object {method: "POST", transformRequest: Array[1], transformResponse: Array[1], url: "http://KD90ZC-PC:1337/api.weitoo.com/server/pub/user/login"}
                            d = a.headers;
                            var c = xc(a.data, wc(d), a.transformRequest);
                            //c= pured encrypted user data
                            ...
                            return s(a, c, d).then(b, b)
                                //c = "{"nonce":"gw6laljtnrenrfj6rp2f3qia0aylr8rr","hashKey":"077b872f9d14bb69ee8bdd50cdfea2358720384ee794aab90a9ee991e618635d","password":"03fee8d64752","agent":"web","userName":"13760215482","clientId":"27814e4b-3118-bdda-3d2d-cb912f22c49d","mode":"Quick"}"
                        }, t],
                        g = n.when(c);
                    for (r(B, function(a) {
                ...
                function s(c, f, g) {
                    ...
                    if (x)
                        if (H = x.get(v),
                            ...
                            x.put(v, r);
                    y(H) &&
                        ((H = Pb(c.url) ? b.cookies()[c.xsrfCookieName || e.xsrfCookieName] : t) && (g[c.xsrfHeaderName || e.xsrfHeaderName] = H),
        ...
        function ye(b, a, c, d, e) {
            ...
            return function(method, pageUrl, userInfo, l, n, timeExe, q, s) {
                ...
                function E() {
                    B = g;
                    R && R();
                    XHLHttpRequset && XHLHttpRequset.abort()
                }

                function u(a, d, method, f, g) {
                    //method not allowed
                    K && c.cancel(K);
                    R = XHLHttpRequset = null;
                    0 === d && (d = method ? 200 : "file" == ua(pageUrl).protocol ? 404 : 0);
                    a(1223 === d ? 204 : d, e, f, g || "");
                    b.$$completeOutstandingRequest(F)
                }
                var B;
                b.$$incOutstandingRequestCount();
                pageUrl = pageUrl || b.url();
                if ("jsonp" == M(method)) {
                    ...
                    var XHLHttpRequset = a(method);
                    XHLHttpRequset.open(method, pageUrl, !0);
                    r(n, function(a, b) {
                        z(a) && XHLHttpRequset.setRequestHeader(b, a)
                    });
                    XHLHttpRequset.onreadystatechange = function() {
                        //onreadystatechange 事件,当请求被发送到服务器时，我们需要执行一些基于响应的任务。每当 readyState 改变时，就会触发 onreadystatechange 事件。
                        //readyState 属性存有 XMLHttpRequest 的状态信息。
                        if (XHLHttpRequset && 4 == XHLHttpRequset.readyState) {
                            var a = null,
                                b = null,
                                c = "";
                            B !== g && (a = XHLHttpRequset.getAllResponseHeaders(),
                                b = "response" in XHLHttpRequset ? XHLHttpRequset.response : XHLHttpRequset.responseText);

                            B === g &&
                                10 > Q || (c = XHLHttpRequset.statusText);
                            u(l, B || XHLHttpRequset.status, b, a, c)
                        }
                    };
                    q && (XHLHttpRequset.withCredentials = !0);
                    if (s)
                        try {
                            XHLHttpRequset.responseType = s
                        } catch (ca) {
                            if ("json" !== s)
                                throw ca;
                        }
                    XHLHttpRequset.send(userInfo || null)
                    console.log('userInfo=' + userInfo)
                        //h includ user information
                }
                if (0 < timeExe)
                    var K = c(E, timeExe);

                else
                    timeExe && timeExe(timeExe.then) && timeExe.then(E)
            }
        }
            ...
            this.$get = ["$parse", "$exceptionHandler", "$sce", function(c, d, e) {
                function f(f, h, l) {
                    for (var n, p, q = 0, s = [], E = f.length, u = !1, B = []; q < E;)
                        - 1 != (n = f.indexOf(b, q)) && -1 != (p = f.indexOf(a,
                            n + g)) ? (q != n && s.push(f.substring(q, n)),
                            s.push(q = c(u = f.substring(n + g, p))),
                            q.exp = u,
                            q = p + k,
                            u = !0) : (q != E && s.push(f.substring(q)),
                            q = E);
                    (E = s.length) || (s.push(""),
                        E = 1);
                    if (l && 1 < s.length)
        ...
        function Wd() {
            ...
            this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", function(c, d, e, f) {
                ...
                var k, m, h = d.baseHref(),
                    l = d.url(),
                    n;
                a ? (n = l.substring(0, l.indexOf("/", l.indexOf("//") + 2)) + (h || "/"),
                    m = e.history ? Bc : Ub) : (n =
                    eb(l),
                    m = Tb);
                k = new m(n, "#" + b);
                ...
                d.onUrlChange(function(a) {
                    k.absUrl() != a && (c.$evalAsync(function() {
                            ...
                            c.$broadcast("$locationChangeStart",
                                a, b).defaultPrevented ? (k.$$parse(b),
                                d.url(b)) : g(b)
                        }),
                        c.$$phase || c.$digest())
                });
            ...
            this.$get = ["$window", function(c) {
                ...
                function warnFunc(a) {
                    ...
                    return a ? function() {
                        ...
                        return warnFunc.apply(b, a)
                            //output the msg of interface and userinfo
                    } : function(a, b) {
                        warnFunc(a, null == b ? "" : b)
                    }
                }
                return {
                    ...
                    info: warnFunc("info"),
                    warn: warnFunc("warn"),
                    error: warnFunc("error"),
                    debug: function() {
                            var c = warnFunc("debug");
                            return function() {
            ...
            if (a.csp)
                f = 6 > e ? Dc(d[0], d[1], d[2], d[3], d[4], c, a) : function(b, f) {
                    var g = 0,
                        k;
                    do
                        k = Dc(d[g++], d[g++], d[g++], d[g++], d[g++], c, a)(b, f),
                        f = t,
                        b = k;
                    while (g < e);
                    return k
        ...
        function Yd() {
            ...
            this.$get = ["$filter", "$sniffer", "$log", function(c, d, e) {
                a.csp = d.csp;
                wa = function(b) {
                    a.logPromiseWarnings && !Fc.hasOwnProperty(b) && (Fc[b] = !0,
                ...
                k.prototype = {
                    ...
                    $new: function(a) {
                        a ? (a = new k,
                            ...
                            a.$$postDigestQueue = this.$$postDigestQueue) : (this.$$childScopeClass || (this.$$childScopeClass =
                                function() {
                        ...
                        do {
                            ...
                            a: do {
                                ...
                                //$$watchers:Array[24]
                                    ...
                                    try {
                                        if (d = h[R])
                                        //d = object--loginBean-pwd
                                            if ((f = d.get(K)) !== (k = d.last) && !(d.eq ? Aa(f, k) : "number" === typeof f && "number" === typeof k && isNaN(f) && isNaN(k)))
                                                w = !0,
                                                c = d,
                                                d.last = d.eq ? Ha(f, null) : f,
                                                d.fn(f, k === n ? f : k, K),
                                                5 > t && (v = 4 - t,
                                                    O[v] || (O[v] = []),
                                                    C = P(d.exp) ? "fn: " + (d.exp.name || d.exp.toString()) :
                                                    d.exp,
                                                    C += "; newVal: " + na(f) + "; oldVal: " + na(k),
                                                    O[v].push(C));
                                            else if (d === c) {
                                            w = !1;
                                            break a
                    ...
                    $destroy: function() {
                        if (!this.$$destroyed) {
                            ...
                            this !== p && (r(this.$$listenerCount,
                                ...
                                this.$destroy = this.$digest = this.$apply = F,
                                this.$on =
                                this.$watch = function() {
                                    return F
                                }
                    ...
                    $evalAsync: function(a) {
                        //$digest循环运行的第二个操作是执行$$asyncQueue。可以使用$evalAsync()方法访问这个工作队列
                        //脏值检查完毕后，asyncQueue队列是空的，所以我们在脏值检测阶段通过$evalAsync()把函数加到队列里，然后执行异步列表，然后再来一轮$digest循环

                        // angular事件循环通常称为$digest循环。$digest循环分两步：$watch列表，$evalAsync列表
        ...
        function ce() {
            this.$get = ["$window", "$document", function(b, a) {
                ...
                if (h) {
                    ...
                    !d || l && n || (l = A(f.body.style.webkitTransition),
                        n = A(f.body.style.webkitAnimation))
                }
                return {
        ...
        function Jc(b) {
            ...
            return function(c, e) {
                ...
                if (!ta(c))
                    return c;
                for (; e;)
                    (m = Ie.exec(e)) ? (g = g.concat(Ba.call(m, 1)),
                        e = g.pop()) : (g.push(e),
                        e = null);
                r(g, function(a) {
                    k = Je[a];
        ...
        function Lc(b) {
            return function(a, c, d) {
                ...
                function f(a, b) {
                    var c = typeof a,
                        d = typeof b;
                    return c == d ? (ta(a) && ta(b) && (a = a.valueOf(),
                            b = b.valueOf()),
        ...
        function Ab(b, a, c, d, e, f) {
            ...
            var n = function(e) {
                if (!l) {
                    ...
                    if (Q && "input" === (e || m).type && a[0].placeholder !== k)
                        k = a[0].placeholder;
                    else if ("passwd" !== h && Ua(c.ngTrim || "T") && (f = aa(f)),
                        //f=pwd
            ...
            var s = c.ngPattern;
            s && ((e = s.match(/^\/(.*)\/([gim]*)$/)) ? (s = RegExp(e[1], e[2]),
                    e = function(a) {
                        return sa(d,
        ...
        var La = S.prototype = {
                ready: function(b) {
                    ...
                    var c = !1;
                    "complete" === X.readyState ? setTimeout(a) : (this.on("DOMContentLoaded", a),
                        S(W).on("load", a))
                },
                toString: function() {
                    var b = [];
            ...
            S.prototype[c] =
                function(c, e, f) {
                    for (var g, k = 0; k < this.length; k++)
                        y(g) ? (g = a(this[k], c, e, f),
                            z(g) && (g = v(g))) : Jb(g, a(this[k], c, e, f));
                    return z(g) ? g : this
                };
                ...
                for (var d = "", e = a, f = !1; this.index < this.text.length;) {
                    ...
                    if (f)
                        "u" === g ? (f = this.text.substring(this.index + 1, this.index + 5),
                            ...
                            this.index += 4,
                            d += String.fromCharCode(parseInt(f, 16))) : d += Re[g] || g,
                        f = !1;
                    else if ("\\" === g)
                        f = !0;
                    else {
        ...
        fb.prototype = {
            ...
            functionCall: function(a, c) {
                ...
                return function(f, g) {
                    ...
                    //m = a.$$childScopeClass.$$childScopeClass including account and pwd
                    //调用$scope.$digest()，循环开始，digest循环遍历每一个watcher来检测是否有变化，如果变化watcher中的回调函数会被调用更新view的值
                    //AngularJS并不直接调用$digest()，而是调用$scope.$apply()，$scope.$apply()会调用$rootScope.$digest()，所以，$digest循环在$rootScope开始
                    //随后会访问到所有的children scope中的watchers。
                    //1，使用setTimeout()来更新一个scope model 需要手动调用apply()
                    //2,设置一个DOM事件listener并且在该listener中修改了一些models,也需要手动调用apply()
                    //watcher的第二个函数被称为监听模式
                    return va(k, e.text)
                        //login进来
                }
            },
                        ...
                        return function(g, k, q, r, E) {
                            ...
                            g.$watch(f.parseAsResourceUrl(m), function(f) {
                                ...
                                f ? (a.get(f, {
                                    ...
                                    g.$emit("$includeContentRequested")) : (w(),
                                    r.template = null)
                            })
                        }
                    }
                ...
                return {
                    ...
                    link: function(e, g, k, m) {
                        function h(a, c, d, e) {
                            d.$render = function() {
                                ...
                                e.hasOption(a) ? (A.parent() && A.remove(),
                                    c.val(a),
                                    "" === a && u.prop("selected", !0)) : y(a) && u ? c.val("") : e.renderUnknownOption(a)
                            };
                        ...
                        function l(a, c, d) {
                            ...
                            a.$watch(function() {
                                Aa(e, d.$viewValue) || (e = ha(d.$viewValue),
                                    d.$render())
                            });
                            c.on("change", function() {
                                a.$apply(function() {
                        ...
                        function n(e, f, g) {
                            function k() {
                                ...
                                for (x = 0; F = A.length,
                                    ...
                                    (h = a[d]) || (h = a[d] = [],
                                        c.push(d));
                                    q ? d = z(w.remove(v ? v(e, L) : r(e, L))) : (v ? (d = {},
                                            d[m] = s,
                                            d = v(e, d) === v(e, L)) : d = s === r(e, L),
                                        w = w || d);
                                    C = l(e, L);
                                    C = z(C) ? C : "";
                                    h.push({
                                ...
                                for (A = c.length; L < A; L++) {
                                    ...
                                    y.length <= L ? (s = {
                                        ...
                                        t = [s],
                                        y.push(t),
                                        f.append(s.element)) : (t = y[L],
                                        s = t[0],
                                        s.label != d && s.element.attr("label", s.label = d));
                                    C = null;
                                    x = 0;
                                    for (F = h.length; x < F; x++)
                                        d = h[x], (w = t[x + 1]) ? (C = w.element,
                                            w.label !== d.label && C.text(w.label = d.label),
                                            w.id !== d.id && C.val(w.id = d.id),
                                            C[0].selected !== d.selected && (C.prop("selected", w.selected = d.selected),
                                            ...
                                            C ? C.after(J) : s.element.append(J),
                                            C = J);
                                    for (x++; t.length > x;)
    ...
    ! function(a, b) {
            ...
            this.when = function(a, e) {
                ...
                this.$get = ["$rootScope", "$location", "$routeParams", "$q", "$injector", "$http", "$templateCache", "$sce", function(d, e, f, g, h, i, j, k) {
                    ...
                    function o() {
                        var a = p(),
                            c = m.current;
                        a && c && a.$$route === c.$$route && b.equals(a.pathParams, c.pathParams) && !a.reloadOnSearch && !l ? (c.params = a.params,
                            b.copy(c.params, f),
                            d.$broadcast("$routeUpdate", c)) : (a || c) && (l = !1,
                            d.$broadcast("$routeChangeStart", a, c),
                            m.current = a,
                            a && a.redirectTo && (b.isString(a.redirectTo) ? e.path(q(a.redirectTo, a.params)).search(a.params).replace() : e.url(a.redirectTo(a.pathParams, e.path(), e.search())).replace()),
                            g.when(a).then(function() {
                                if (a) {
                                    var d, e, c = b.extend({}, a.resolve);
                                    return b.forEach(c, function(a, d) {
                                        ...
                                        b.isDefined(d = a.template) ? b.isFunction(d) && (d = d(a.params)) : b.isDefined(e = a.templateUrl) && (b.isFunction(e) && (e = e(a.params)),
                                            ...
                                            b.isDefined(e) && (a.loadedTemplateUrl = e,
                                                d = i.get(e, {
                                                    cache: j
                                                }).then(function(a) {
                                                    return a.data
                                ...
                                a == m.current && (a && (a.locals = e,
                                        b.copy(a.params, f)),
                                    d.$broadcast("$routeChangeSuccess", a, c))
                            }, function(b) {
                                a == m.current && d.$broadcast("$routeChangeError", a, c, b)
                            }))
                    }
                    ...
                    return d.$on("$locationChangeSuccess", o),
                        m
                }]
        }
                    ...
                    function p() {
                        ...
                        if (b.isDefined(h)) {
                            var l = e.$new(),
                                p = a.current,
                                q = i(l, function(a) {
                                    d.enter(a, null, k || f, function() {
                                            !b.isDefined(m) || m && !e.$eval(m) || c()
                                        }),
                                        o()
                                });
                            k = q,
        ...
        d.provider("$routeParams", f),
            ...
            g.$inject = ["$route", "$anchorScroll", "$animate"],
            h.$inject = ["$compile", "$controller", "$route"]
    }
...
define("angular/plugins/translate/angular-translate", [], function(require, exports, module) {
    angular.module("ngTranslate", ["ng"]).run(["$translate", function(a) {
            var b = a.storageKey(),
                c = a.storage();
        ...
        angular.module("ngTranslate").provider("$translate", ["$STORAGE_KEY", function(a) {
            var b, c, d, e, f, g, h, i, j, k, l, m, n = {},
                ...
                r = function(a, b) {
                    ...
                    if (a && !b) {
                        ...
                        angular.isObject(n[a]) || (n[a] = {}),
                        angular.extend(n[a], s(b));
                    return this
                },
                s = function(a, b, c, d) {
                    var e, f, g;
                    b || (b = []),
                        c || (c = {});
                    for (e in a)
                        a.hasOwnProperty(e) && (g = a[e],
                            angular.isObject(g) ? s(g, b.concat(e), c, e) : (f = b.length ? "" + b.join(q) + q + e : e,
                                b.length && e === d && (keyWithShortPath = "" + b.join(q),
                                    c[keyWithShortPath] = "@:" + f),
                                c[f] = g));
                    return c
                };
            this.translations = r,
                ...
                this.fallbackLanguage = function(a) {
                    return a ? (("string" == typeof a || angular.isArray(a)) && (c = a),
                        this) : c
                },
            ...
            this.storageKey = t,
                ...
                this.$get = ["$log", "$injector", "$rootScope", "$q", function(a, g, o, q) {
                    var s, u = g.get(i || "$translateDefaultInterpolation"),
                        v = !1,
                        w = {},
                        x = function(a) {
                            if (!a)
                            ...
                            var b = q.defer();
                            return o.$broadcast("$translateLoadingStart"),
                                v = !0,
                                g.get(j)(angular.extend(k, {
                                    key: a
                                })).then(function(c) {
                                    ...
                                    angular.isArray(c) ? angular.forEach(c, function(a) {
                                        ...
                                        o.$broadcast("$translateLoadingEnd")
                                }, function(a) {
                                    o.$broadcast("$translateLoadingError"),
                                        b.reject(a),
                                        o.$broadcast("$translateLoadingEnd")
                                }),
                                b.promise
                        };
                    if (f && (s = g.get(f), !s.get || !s.set))
                        throw new Error("Couldn't use storage '" + f + "', missing get() or set() method!");
                    p.length > 0 && angular.forEach(p, function(a) {
                        var c = g.get(a);
                        c.setLocale(b || d),
                            w[c.getInterpolationIdentifier()] = c
                    });
                    var y = function(a) {
                            if (a && c) {
                                if (angular.isArray(c)) {
                                    for (var b = c.length, e = 0; b > e; e++)
                                        if (d === n[c[e]])
                                            return !1;
                                    return !0
                                }
                        ...
                        z = function(a, b, e) {
                            var f = d ? n[d] : n,
                                i = e ? w[e] : u;
                            if (f && f.hasOwnProperty(a))
                                return angular.isString(f[a]) && "@:" === f[a].substr(0, 2) ? z(f[a].substr(2), b, e) : i.interpolate(f[a], b);
                            h && !v && g.get(h)(a, d);
                            var j;
                            if (d && c && y(d)) {
                                "string" == typeof c ? (j = [],
                                    j.push(c)) : j = c;
                                for (var k = j.length, o = 0; k > o; o++)
                                    if (d !== n[j[o]]) {
                                        var p = n[j[o]][a];
                                        if (p) {
                                            var q;
                                            return i.setLocale(j[o]),
                                                q = i.interpolate(p, b),
                                                i.setLocale(d),
                                                q
                                        }
                    ...
                    if (z.preferredLanguage = function() {
                        ...
                        z.uses = function(a) {
                            function b(a) {
                                d = a,
                                    o.$broadcast("$translateChangeSuccess"),
                                    f && s.set(z.storageKey(), d),
                                    u.setLocale(d),
                                    angular.forEach(w, function(a, b) {
                                        w[b].setLocale(d)
                                    }),
                                    c.resolve(a),
                                    o.$broadcast("$translateChangeEnd")
                            }
                            if (!a)
                                return d;
                            var c = q.defer();
                            return o.$broadcast("$translateChangeStart"), !n[a] && j ? (e = a,
                                    x(a).then(function(a) {
                                        e = void 0,
                                            r(a.key, a.table),
                                            b(a.key)
                                        ...
                                        e = void 0,
                                            o.$broadcast("$translateChangeError"),
                                            c.reject(a),
                                            o.$broadcast("$translateChangeEnd")
                                    })) : b(a),
                                c.promise
                        ...
                        z.refresh = function(a) {
                            function b() {
                                f.resolve(),
                                    o.$broadcast("$translateRefreshEnd")
                            }
                            ...
                            if (a)
                                ...
                                if (c)
                                    if ("string" == typeof c)
                                        ...
                                        for (var i = c.length, k = 0; i > k; k++)
                                            h.push(x(c[k]));
                                d && h.push(x(d)),
                                    h.length > 0 ? q.all(h).then(function(a) {
                                        for (var c in n)
                                        ...
                                        a === d && o.$broadcast("$translateChangeError"),
                                            e()
                                    }) : b()
                            }
                            return f.promise
                        },
                        j && (angular.equals(n, {}) && z.uses(z.uses()),
                            c))
                        if ("string" != typeof c || n[c])
        ...
        angular.module("ngTranslate").factory("$translateDefaultInterpolation", ["$interpolate", function(a) {
            var b, c = {},
                d = "default";
        ...
        angular.module("ngTranslate").directive("translate", ["$filter", "$interpolate", "$parse", function(a, b, c) {
            var d = a("translate");
            return {
                restrict: "AE",
                scope: !0,
                link: function(a, e, f) {
                    f.translateInterpolation && (a.interpolation = f.translateInterpolation),
                        f.$observe("translate", function(c) {
        ...
        angular.module("ngTranslate").filter("translate", ["$parse", "$translate", function(a, b) {
            return function(c, d, e) {
                return angular.isObject(d) || (d = a(d)()),
                    b(c, d, e)
            }
        }]);
});;
                ...
                $get: ["$injector", "$rootScope", "$q", "$http", "$templateCache", "$controller", "$modalStack", function(b, c, d, e, f, g, h) {
                    ...
                    return k.open = function(b) {
                            ...
                            if (b = angular.extend({}, a.options, b),
                                b.resolve = b.resolve || {}, !b.template && !b.templateUrl)
                                    ...
                                    function o() {
                                        return z = null,
                                            ...
                                            D.content ? (q(),
                                                ...
                                                A ? h.find("body").append(w) : c.after(w),
                                                E(),
                                                D.isOpen = !0,
                                                D.$digest(),
                                                E) : angular.noop
