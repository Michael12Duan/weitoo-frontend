define("angular/1.2.25/angular", [], function(require, exports, module) {
    ...
    (function(W, X, t) {
                ...
                if (!d || null != b)
                    for (; e.length;)
                        for (h = e.shift(), l = 0, n = h.length; l < n; l++)
                            for (p = v(h[l]), m ? p.triggerHandler("$destroy") : m = !m, q = 0, p = (s = p.children()).length; q < p; q++) e.push(Ea(s[q]));
        ...
        function oa(b, a, c) {
            var d =
                b.ng339,
                d = ab[d || -1];
            if (z(c)) d || (b.ng339 = d = ++ne, d = ab[d] = {}), d[a] = c;
            else return d && d[a]
        }
        ...
        function te(b, a, c, d) {
            ...
            k.cookies = function(a, b) {
                var d, e, f, k;
                if (a) b === t ? m.cookie = escape(a) + "=;path=" + C + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : A(b) && (d = (m.cookie = escape(a) + "=" + escape(b) + ";path=" + C).length + 1, 4096 < d && c.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!"));
                else {
                    if (m.cookie !==
                        da)
                ...
                function H(a, c, d, e, f, g, m, n, p) {
                    ...
                    for (var u = -Number.MAX_VALUE,
                        ...
                        if (V = G.transclude) y = !0, G.$$tlb ||
                            (db("transclusion", fa, G, Z), fa = G), "element" == V ? (M = !0, u = G.priority, V = Z, Z = d.$$element = v(X.createComment(" " + D + ": " + d[D] + " ")), c = Z[0], Na(f, Ba.call(V, 0), c), S = w(V, e, u, g && g.name, {
        ...
        function ye(b, a, c, d, e) {
            function f(a, b, c) {
                ...
                8 >= Q && (f.onreadystatechange = function() {
                    A(f.readyState) && /loaded|complete/.test(f.readyState) && (f.onreadystatechange = null, g({
                        type: "load"
                    }))
                });
                            ...
                            a: do {
                                if (h = K.$$watchers)
                                    for (R = h.length; R--;) try {
                                        if (d = h[R])
                                            if ((f = d.get(K)) !== (k = d.last) && !(d.eq ? Aa(f, k) : "number" === typeof f && "number" === typeof k && isNaN(f) && isNaN(k))) w = !0, c = d, d.last = d.eq ? Ha(f, null) : f, d.fn(f, k === n ? f : k, K), 5 > t && (v = 4 - t, O[v] || (O[v] = []), C = P(d.exp) ? "fn: " + (d.exp.name || d.exp.toString()) :
                                                d.exp, C += "; newVal: " + na(f) + "; oldVal: " + na(k), O[v].push(C));
                                            else if (d === c) {
                                            w = !1;
                                            break a
                                        }
        ...
        r({
            ...
            attr: function(b, a, c) {
                ...
                if (qb[d])
                    ...
                    else return b[a] || (b.attributes.getNamedItem(a) || F).specified ? d : t;
            ...
            search: function(a, c) {
                switch (arguments.length) {
                    case 0:
                        return this.$$search;
                    case 1:
                        if (A(a) || ib(a)) a = a.toString(), this.$$search = ec(a);
                ...
                return {
                    ...
                    link: function(e, f, g, k, m) {
                        ...
                        e.$watchCollection(k, function(a) {
                            ...
                            for (g = 0; g < k; g++)
                                if (H = a ===
                                    D ? g : D[g], A = a[H], n = F(H, A, g), Da(n, "`track by` id"), z.hasOwnProperty(n)) y = z[n], delete z[n], B[n] = y, I[g] = y;
                                else {
                            ...
                            function k() {
                                ...
                                if (q)
                                    if (h = g.$modelValue, v && I(h))
                                        for (x = new bb([]), d = {}, w = 0; w < h.length; w++) d[m] = h[w], x.put(v(e, d), h[w]);
                                    else x = new bb(h);
                                w = x;
                                var C, J;
    ...
    ! function(a, b) {
        ...
        function e() {
            ...
            this.when = function(a, e) {
                ...
                function o() {
                    var a = p(),
                        c = m.current;
                    a && c && a.$$route === c.$$route && b.equals(a.pathParams, c.pathParams) && !a.reloadOnSearch && !l ? (c.params = a.params, b.copy(c.params, f), d.$broadcast("$routeUpdate", c)) : (a || c) && (l = !1, d.$broadcast("$routeChangeStart", a, c), m.current = a, a && a.redirectTo && (b.isString(a.redirectTo) ? e.path(q(a.redirectTo, a.params)).search(a.params).replace() : e.url(a.redirectTo(a.pathParams, e.path(), e.search())).replace()), g.when(a).then(function() {
                        if (a) {
                            var d, e, c = b.extend({}, a.resolve);
                            return b.forEach(c, function(a, d) {
                                c[d] = b.isString(a) ? h.get(a) : h.invoke(a)
                            }), b.isDefined(d = a.template) ? b.isFunction(d) && (d = d(a.params)) : b.isDefined(e = a.templateUrl) && (b.isFunction(e) && (e = e(a.params)), e = k.getTrustedResourceUrl(e), b.isDefined(e) && (a.loadedTemplateUrl = e, d = i.get(e, {
                                cache: j
                            }).then(function(a) {
                                return a.data
                            }))), b.isDefined(d) && (c.$template = d), g.all(c)
                        }
                    }).then(function(e) {
                        a == m.current && (a && (a.locals = e, b.copy(a.params, f)), d.$broadcast("$routeChangeSuccess", a, c))
                    }, function(b) {
                ...
                return d.$on("$locationChangeSuccess", o), m
            }]
        }
        ...
        function g(a, c, d) {
            return {
                ...
                link: function(e, f, g, h, i) {
                    function o() {
                        l && (l.remove(), l = null), j && (j.$destroy(), j = null), k && (d.leave(k, function() {
                            l = null
                        }), l = k, k = null)
                    }
                    ...
                    function p() {
                        ...
                        if (b.isDefined(h)) {
                            ...
                            k = q, j = p.scope = l, j.$emit("$viewContentLoaded"), j.$eval(n)
                        } else o()
                    }
                    var j, k, l, m = g.autoscroll,
                        n = g.onload || "";
                    e.$on("$routeChangeSuccess", p), p()
                }
            }
        }
        ...
        d.provider("$routeParams", f), d.directive("ngView", g), d.directive("ngView", h), g.$inject = ["$route", "$anchorScroll", "$animate"], h.$inject = ["$compile", "$controller", "$route"]
