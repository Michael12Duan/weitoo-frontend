...
! function() {
    ...
    function eb(b) {
        ...
        function Rb(a) {
            function e() {
                ...
                if (this instanceof e) {
                    var f = Tb(b.prototype),
                        g = b.apply(f, a || arguments);
                    return Qc(g) ? g : f
                }
        ...
        function Yb(a, b, c, d, e, f) {
            ...
            if (!l) {
                ...
                var o = !Pb.argsObject && jc(a) ? V : a.constructor,
                    p = !Pb.argsObject && jc(b) ? V : b.constructor;
            ...
            if (g = !0, e.push(a), f.push(b), l) {
                if (r = a.length, s = b.length, g = s == r, g || d)
                    for (; s--;) {
                        ...
                        else if (!(g = Yb(a[s], u, c, d, e, f))) break
                    }
        ...
        function Zc(a) {
            var b = arguments,
                c = 2;
            if (!Qc(a)) return a;
            if ("number" != typeof b[2] && (c = b.length), c > 3 && "function" == typeof b[c - 2]) var d = Ub(b[--c - 1], b[c--], 2);
        ...
        function pd(a, b, d) {
            ...
            if (b = Nb.createCallback(b, d, 3), kc(a))
                for (; ++e < f;) g[e] = b(a[e], e, a);
            else uc(a, function(a, c, d) {
                g[++e] = b(a, c, d)
            });
            return g
        }
            ...
            a: for (; ++k < l;) {
                ...
                if (i = j[k], (n ? U(n, i) : e(h, i)) < 0) {
                    for (b = c, (n || h).push(i); --b;)
                        if (n = d[b], (n ? U(n, i) : e(a[b], i)) < 0) continue a;
                    m.push(i)
                }
            }
            for (; c--;) n = d[c], n && cb(n);
        ...
        function Od(a) {
            for (var b = arguments, c = 0, d = b.length, e = a ? a.length : 0; ++c < d;)
                for (var f = -1, g = b[c]; ++f < e;) a[f] === g && (zb.call(a, f--, 1), e--);
            return a
        }
        ...
        function de(b, c, d) {
            ...
            return function() {
                if (e = arguments, h = te(), i = this, k = n && (j || !o), m === !1) var a = o && !j;
                else {
                    f || o || (l = h);
                    var d = m - (h - l),
                        r = 0 >= d;
        ...
        function ge(a, b) {
            ...
            var c = function() {
                var d = c.cache,
                    e = b ? b.apply(this, arguments) : f + arguments[0];
        ...
        function ye(b, c, d) {
            ...
            b = hb(b || ""), d = zc({}, d, e);
            var i, f = zc({}, d.imports, e.imports),
                g = mc(f),
                h = cd(f),
                k = 0,
                o = d.interpolate || s,
                p = "__p += '",
                r = gb((d.escape || s).source + "|" + o.source + "|" + (o === q ? n : s).source + "|" + (d.evaluate || s).source + "|$", "g");
        ...
        var c = b.Array,
            ...
            rb = b.clearTimeout,
            sb = R.floor,
            tb = Q.prototype.toString,
            ub = fc(ub = V.getPrototypeOf) && ub,
            ...
            Bb = function() {
                try {
                    var a = {},
                        b = fc(b = V.defineProperty) && b,
                        c = b(a, a, a) && b
                } catch (d) {}
                return c
            }(),
            Cb = fc(Cb = V.create) && Cb,
            Db = fc(Db = c.isArray) && Db,
            Eb = b.isFinite,
            Fb = b.isNaN,
            Gb = fc(Gb = V.keys) && Gb,
            Hb = R.max,
        ...
        ! function() {
            ...
            try {
                Pb.nodeClass = !(ob.call(document) == F && !({
                    toString: 0
                } + ""))
            } catch (g) {
                Pb.nodeClass = !0
            }
        }(1), Nb.templateSettings = {
            escape: /<%-([\s\S]+?)%>/g,
            evaluate: /<%([\s\S]+?)%>/g,
            interpolate: q,
            variable: "",
    ...
    var a, b = [],
        ...
        t = /\bthis\b/,
        u = /['\n\r\t\u2028\u2029\\]/g,
        v = ["Array", "Boolean", "Date", "Error", "Function", "Math", "Number", "Object", "RegExp", "String", "_", "attachEvent", "clearTimeout", "isFinite", "isNaN", "parseInt", "setTimeout"],
    ...
    var J = {
        ...
        O = M[typeof window] && window || this,
        P = M[typeof exports] && exports && !exports.nodeType && exports,
